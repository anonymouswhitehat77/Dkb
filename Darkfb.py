...
def loginSC():
	...
	if username =="Termux" and password =="gilangriyoko":
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/GILANG RIYOKO')
				menu()
